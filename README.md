...
<p align="center">
  <img src="https://github.com/arthur404dev/gopportunities/raw/e8a0b106435258788879ac7afc7df502b874d729/assets/GopportunitiesHeader.svg" alt="GoJob Header">
</p>

This project that i did in a course and  is a modern job opportunities API built using Golang. The API is powered by Go-Gin as a router, GoORM for database communication, SQLite as the database, and Swagger for API documentation and testing. The project follows a modern package structure to keep the codebase organized and maintainable.
...
![Captura de tela de 2023-06-01 18-52-47](https://github.com/lucasdamasceno96/gopportunities/assets/105467049/b0b6c080-305e-4ea6-82cb-90085d8e2a39)
